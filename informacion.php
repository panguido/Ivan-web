...
<div class="container">
    ...
    <div id="legalprom-bio" class="row">
        <div class="col-md-5">
            <img alt="Logo LegalProm" src="../Ivan-web/multimedia/logo.png">
        </div>
        <div class="col-md-7">
            <p>
                ...
                Buscamos el acceso de todos a una <strong>atención legal de primer nivel a precios accesibles</strong><br><br>
            </p>
        </div>
    </div>
