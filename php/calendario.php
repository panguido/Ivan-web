...
var_dump ($_POST);
	...
	if(isset($_POST["nombre"])  &&isset($_POST["email"])&& isset($_POST["residencia"]) &&isset($_POST["empleado"])&& isset($_POST["fecha_Cita"]) && isset($_POST["hora"])){
			...
			$found=false;
	$sql= "INSERT INTO `citas`(`nombre`, `email`, `residencia`, `empleado`, `fecha`, `hora`) VALUES ('$_POST[nombre]','$_POST[email]','$_POST[residencia]','$_POST[compannero]','$_POST[fecha_Cita]','$_POST[hora]')";
